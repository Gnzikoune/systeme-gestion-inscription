      ...
      <div className="container mx-auto px-4 py-8 sm:py-10">
        <div className="grid gap-8 md:grid-cols-3">
          <div>
            ...
            <h3 className="mb-2 text-base sm:text-lg md:text-xl font-bold text-foreground">CSGR-IA</h3>
            <p className="mb-4 text-[10px] sm:text-xs md:text-sm text-muted-foreground leading-relaxed">
          ...
          <div>
            <h3 className="mb-3 sm:mb-4 text-sm font-medium text-foreground">Partenaires</h3>
          ...
          <div>
            <h3 className="mb-3 sm:mb-4 text-sm font-medium text-foreground">Contact</h3>
        ...
        <div className="mt-6 sm:mt-8 border-t border-border pt-6 sm:pt-8 text-center text-sm text-muted-foreground">
