    ...
    <div className="min-h-screen p-3 sm:p-4 md:p-6 lg:p-8">
      ...
      <div className="mb-4 sm:mb-6 md:mb-8">
        <div className="flex items-center gap-2 sm:gap-3 mb-1.5 sm:mb-2">
          ...
          <h1 className="text-xl font-bold text-foreground sm:text-2xl md:text-2xl lg:text-2xl">Paramètres</h1>
        </div>
        <p className="text-xs text-muted-foreground sm:text-sm md:text-sm lg:text-sm">
