...
export default function ConfirmationPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 bg-muted/30 py-8 sm:py-12 md:py-16">
          ...
          <div className="mx-auto max-w-2xl">
            <Card>
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-balance text-xl sm:text-2xl md:text-3xl">Inscription confirmée !</CardTitle>
              ...
              <CardContent className="space-y-6">
                <div className="rounded-lg border border-border bg-muted/50 p-3 sm:p-4">
                  <div className="space-y-2 sm:space-y-3">
                    ...
                    <div className="flex items-center justify-between border-t border-border pt-2 sm:pt-3 text-xs sm:text-sm md:text-base">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-2 sm:gap-3 rounded-lg bg-primary/5 p-3 sm:p-4">
                    <Mail className="mt-0.5 h-4 w-4 sm:h-5 sm:w-5 shrink-0 text-primary" />
                    <div>
                      <p className="text-xs sm:text-sm md:text-base font-medium text-foreground">Email de confirmation envoyé</p>
                  ...
                  <div className="flex items-start gap-2 sm:gap-3 rounded-lg bg-accent/5 p-3 sm:p-4">
                    <Calendar className="mt-0.5 h-4 w-4 sm:h-5 sm:w-5 shrink-0 text-accent" />
                    <div>
                      <p className="text-xs sm:text-sm md:text-base font-medium text-foreground">Prochaines étapes</p>
                      <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
